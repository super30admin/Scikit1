'''
1. J48 is a machine learning decision tree classification algorithm based on Iterative Dichotomiser 3. helpful in examine the data categorically and continuously.
2.  Using the weka tool building the J48 tool
3. Using Java API
'''
